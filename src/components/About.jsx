  ...
  return (
    <section id="about" className="bg-surface-container-low py-stack-lg">
      ...
      >
        ...
        <motion.h2 variants={fadeUp} className="font-display text-headline-lg-mobile md:text-headline-lg text-primary">
          Tentang Saya
        </motion.h2>
        ...
        <motion.p
          ...
          className="font-body-lg text-body-md md:text-body-lg text-on-surface-variant leading-relaxed"
        >
          Mahir mengoperasikan <span className="font-bold text-primary">SIMRS (Teramedik), sistem BPJS (M-JKN, VClaim, E-Klaim, LUPIC)</span>, 
          serta berbagai <span className="font-bold text-primary">portal asuransi swasta mitra (YKP BJB, AdMedika, Inhealth, PLN, dll.)</span>.
        </motion.p>
